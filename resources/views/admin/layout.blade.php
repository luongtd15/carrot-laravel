    ...
    <main class="wrapper sb-default ecom">
                                    ...
                                    <ul class="border-top">
                                        <li>
                                            <form action="{{ route('logout') }}" method="POST">
                                                @csrf
                                                <i class="ri-logout-circle-r-line"></i><button type="submit"
                                                    style="border: none; font-size: small; background: none; position: relative; top: -3.5px; color: gray;"
                                                    onclick="return confirm('You want logout?')">Logout</button>
                                            </form>
        ...
        <div class="cr-sidebar" data-mode="light">
            <div class="cr-sb-logo">
                <a href="{{ route('dashboard') }}" class="sb-full"><img
                        src="{{ asset('admin/assets/img/logo/full-logo.png') }}" alt="logo"></a>
                <a href="{{ route('dashboard') }}" class="sb-collapse"><img
                        src="{{ asset('admin/assets/img/logo/collapse-logo.png') }}" alt="logo"></a>
            </div>
            ...
            <div class="cr-sb-wrapper">
                ...
                <div class="cr-sb-content">
                    <ul class="cr-sb-list">
                        ...
                        <li class="cr-sb-item-separator"></li>
                        <li class="cr-sb-item sb-drop-item">
                            <a href="{{ route('admin.orders') }}" class="cr-drop-toggle">
                                <i class="ri-shield-user-line"></i><span class="condense">Orders</span></a>
                        </li>
                        <li class="cr-sb-item-separator"></li>
                        <li class="cr-sb-item sb-drop-item">
                            <a href="{{ route('admin.comments.index') }}" class="cr-drop-toggle">
                                <i class="ri-shield-user-line"></i><span class="condense">Comments</span></a>
                        </li>
                ...
                <div class="cr-tools-block">
                    ...
                    <div class="cr-tools-info">
                        <div class="cr-tools-item sidebar active" data-sidebar-mode-tool="light">
                            <img src="{{ asset('admin/assets/img/tools/side-light.png') }}" alt="light">
                            <p>light</p>
                        </div>
                        <div class="cr-tools-item sidebar" data-sidebar-mode-tool="dark">
                            <img src="{{ asset('admin/assets/img/tools/side-dark.png') }}" alt="dark">
                            <p>dark</p>
                        </div>
                        <div class="cr-tools-item sidebar" data-sidebar-mode-tool="bg-1">
                            <img src="{{ asset('admin/assets/img/tools/side-bg-1.png') }}" alt="background">
                            <p>Bg-1</p>
                        </div>
                        <div class="cr-tools-item sidebar" data-sidebar-mode-tool="bg-2">
                            <img src="{{ asset('admin/assets/img/tools/side-bg-2.png') }}" alt="background">
                            <p>Bg-2</p>
                        </div>
                        <div class="cr-tools-item sidebar" data-sidebar-mode-tool="bg-3">
                            <img src="{{ asset('admin/assets/img/tools/side-bg-3.png') }}" alt="background">
                            <p>Bg-3</p>
                        </div>
                        <div class="cr-tools-item sidebar" data-sidebar-mode-tool="bg-4">
                            <img src="{{ asset('admin/assets/img/tools/side-bg-4.png') }}" alt="background">
                            <p>Bg-4</p>
                        </div>
                    </div>
                </div>
                <div class="cr-tools-block">
                    ...
                    <div class="cr-tools-info">
                        <div class="cr-tools-item header active" data-header-mode="light">
                            <img src="{{ asset('admin/assets/img/tools/header-light.png') }}" alt="light">
                            <p>light</p>
                        </div>
                        <div class="cr-tools-item header" data-header-mode="dark">
                            <img src="{{ asset('admin/assets/img/tools/header-dark.png') }}" alt="dark">
                            <p>dark</p>
                        </div>
                    </div>
                </div>
                <div class="cr-tools-block">
                    ...
                    <div class="cr-tools-info">
                        <div class="cr-tools-item bg active" data-bg-mode="default">
                            <img src="{{ asset('admin/assets/img/tools/bg-0.png') }}" alt="default">
                            <p>Default</p>
                        </div>
                        <div class="cr-tools-item bg" data-bg-mode="bg-1">
                            <img src="{{ asset('admin/assets/img/tools/bg-1.png') }}" alt="bg-1">
                            <p>Bg-1</p>
                        </div>
                        <div class="cr-tools-item bg" data-bg-mode="bg-2">
                            <img src="{{ asset('admin/assets/img/tools/bg-2.png') }}" alt="bg-2">
                            <p>Bg-2</p>
                        </div>
                        <div class="cr-tools-item bg" data-bg-mode="bg-3">
                            <img src="{{ asset('admin/assets/img/tools/bg-3.png') }}" alt="bg-3">
                            <p>Bg-3</p>
                        </div>
                        <div class="cr-tools-item bg" data-bg-mode="bg-4">
                            <img src="{{ asset('admin/assets/img/tools/bg-4.png') }}" alt="bg-4">
                            <p>Bg-4</p>
                        </div>
                        <div class="cr-tools-item bg" data-bg-mode="bg-5">
                            <img src="{{ asset('admin/assets/img/tools/bg-5.png') }}" alt="bg-5">
                            <p>Bg-5</p>
                        </div>
                    </div>
                </div>
